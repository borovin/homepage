...
module.exports = function(grunt) {
    ...
    grunt.config.init({
        ...
        shell: {
            ...
            test: {
                command: 'casperjs test tests/<%- grunt.option("suite") ? grunt.option("suite") + ".js" : "" %> --host=<%- grunt.option("host") || "http://localhost:8080" %>/test.html --includes=./tools/casperInclude.js --platform=' + os.platform()
            },
